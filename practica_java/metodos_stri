...
public static void main(String[] args) {
    ...
    String cade = "Cadena";
    String cade1 = "Cadena";
    //Con equals tienen que se exactamente iguales en escritura y no solo en contenido
    boolean result = cade.equals(cade1);
    System.out.println(result);
    //Con equalsIgnoreCase nos fijamos si el contenido es el mismo y estandarizamos de cierta forma la escritura para compararlos
